 ...
 */
class getBrandsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BrandsRepository' shared autowired service.
     *
     * @return \App\Repository\BrandsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BrandsRepository.php';

        return $container->privates['App\\Repository\\BrandsRepository'] = new \App\Repository\BrandsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
